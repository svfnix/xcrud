...
class Xcrud_config
{
    ...
    public static $dbpass = 'passwd'; // // Your database password
    ...
    public static $language = 'fa'; // sets default localization
    ...
    // editor
    public static $editor_url = '/vendor/xcrud/editors/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    ...
    // xcrud folder url
    public static $scripts_url = '/vendor/xcrud'; // URL to the xCRUD folder, not real path, without a trailing slash, can be relative, e.g. 'some_folder/xcrud' or absolute, e.g. 'http://www.your_site.com/some_folder/xcrud'. If empty - will be detected automatically
    public static $urls2abs = false; // makes relative urls to absolute. Turn off if you have some troubles with relative urls.
    ...
    public static $ajax_uri = '/xcrud.ajax'; // main ajax file or url
